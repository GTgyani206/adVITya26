...
const MobileHeroSection = ({
    ...
    return (
        <div className="relative bg-[#12001A] transition-all duration-500  h-[100dvh] w-full overflow-hidden flex flex-col">
            ...
            <motion.div
                className="flex flex-col h-full pt-20 pb-4 px-3 gap-3 z-10"
            ...
            >
                ...
                <motion.div
                    ...
                    className="flex justify-center gap-3 shrink-0"
                >
                ...
                <motion.div
                    variants={itemVariants}
                    className="relative rounded-2xl backdrop-blur-xl p-3 flex-1 min-h-0 flex flex-col justify-center"
                >



                    <div className="relative z-10 text-white px-6 pt-16">
                        <div className='text-xs font-bold uppercase tracking-wide flex flex-wrap gap-2 mb-1 opacity-90'>
                        ...
                        <PaintReveal
                            ...
                            className="my-1 w-full max-h-16 object-contain"
                        />

                        <div className='text-base font-bold text-right tracking-tight text-[#EFD2FF]'>
                    ...
                    <div className="">
                        <div className="">
                            <div className="flex-shrink-0">
                                {/* <div className='w-80 h-80 bg-[#EFD2FF] left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 absolute rounded-full'></div> */}
                                <MobileRecordPlayer
                                    isPlaying={isPlaying}
                                    audioRef={audioRef}
                ...
                {/* Grid: Video + Booking - Fixed height at bottom */}
                <motion.div variants={itemVariants} className="grid grid-cols-2 gap-3 h-32">
